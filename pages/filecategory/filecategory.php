            ...
            <?php include "../modals/account_modal.php"; ?>
                <div class="container-fluid">
                    <div class="block-header">
                        <button data-target="#addFileCatModal" data-toggle="modal" class="btn btn-primary btn-sm  waves-effect"> <i class="small material-icons">add</i> Add File Category</button>
                            ...
                            <div class="card">
                                ...
                                <form method="post">
                                    <table id="dttbl" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                            $q = mysqli_query($con,"SELECT * from tblfilecategory where deadline >= DATE(NOW()) ");
                                            while($row = mysqli_fetch_array($q)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['deadline'].'</td>
                                                    <td><button type="button" data-target="#editFileCatModal'.$row['id'].'" data-toggle="modal" class="btn btn-primary btn-sm  waves-effect"><i class="small material-icons">create</i> Edit</button></td>
                                                </tr>';
