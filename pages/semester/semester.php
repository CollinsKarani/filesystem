                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_array($q)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['semester'].'</td>
                                                    <td><button type="button" data-target="#editSemesterModal'.$row['id'].'" data-toggle="modal" class="btn btn-primary btn-sm  waves-effect"><i class="small material-icons">create</i> Edit</button></td>
                                                </tr>';
